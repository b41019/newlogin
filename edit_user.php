...
// 編輯會員資料用
$user_id=$_GET['id']; //login 資料表id.member資料表login_id
...
<div class="container">
<h2>編輯資料</h2>
    <form action="safe_user.php" method="post" class="col-md-6">
<div class="list-group">
    ...
    <select name="role" id="">
                ...
                <option value="管理員" <?=($user['role']=='管理員')?"selected":"";?>>管理員</option>on>
            
    </li>
    
</div>
<input type="submit" value="確認新增" class="btn btn-primary my-3">
<input type="reset" value="重製" class="btn btn-primary my-3">
